...
function displayBoxes() {
    ...
    boxes.forEach(box => {
        ...
        resultDiv.innerHTML += `<p>Tipo desde Caja ${box.type}: ${box.quantity} cajas (${box.width}x${box.height}x${box.length} cm) - Volumen Total: ${totalBoxVolume} cm³</p>`;
    });
}
...
function reset() {
    // Limpiar la lista de cajas
    boxes = [];
    console.log('Cajas limpiadas:', boxes);
